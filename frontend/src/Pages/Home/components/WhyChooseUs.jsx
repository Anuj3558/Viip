      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 animate__animated animate__fadeInUp">
            ...
            <h3 className="text-xl font-semibold text-blue-900 text-center mb-4">Comprehensive Solutions</h3>
            <p className="text-gray-600 text-center">We offer a wide array of services, from expert consultations to business setup and compliance.</p>
          </div>
          ...
          <div className="group bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 animate__animated animate__fadeInUp" style={{ animationDelay: '0.2s' }}>
            ...
            <h3 className="text-xl font-semibold text-blue-900 text-center mb-4">Client-Focused Approach</h3>
            <p className="text-gray-600 text-center">Your success is our priority; we tailor our services to align with your specific business goals.</p>
          </div>
          ...
          <div className="group bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 animate__animated animate__fadeInUp" style={{ animationDelay: '0.4s' }}>
            ...
            <h3 className="text-xl font-semibold text-blue-900 text-center mb-4">Extensive Network</h3>
            <p className="text-gray-600 text-center">Benefit from our broad network of legal experts and business consultants, ensuring top-notch service.</p>
          </div>
            ...
            <div className="bg-gradient-to-r from-blue-900 to-blue-700 rounded-2xl p-12 animate__animated animate__fadeIn">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-white text-center">
                <div className="counter-item">
                  <div className="text-4xl font-bold mb-2 counter" data-target="95">0</div>
                  <p>Client Satisfaction</p>
                </div>
                <div className="counter-item">
                  <div className="text-4xl font-bold mb-2 counter" data-target="800">0</div>
                  <p>Businesses Supported</p>
                </div>
                <div className="counter-item">
                  <div className="text-4xl font-bold mb-2 counter" data-target="1200">0</div>
                  <p>Happy Clients</p>
                </div>
                <div className="counter-item">
                  <div className="text-4xl font-bold mb-2 counter" data-target="10">0</div>
