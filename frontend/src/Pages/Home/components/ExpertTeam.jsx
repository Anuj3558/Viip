      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate__animated animate__fadeIn">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-900">
            ENGAGE THE PREEMINENT INTELLECTUAL PROPERTY LEGAL EXPERTS
          </h2>
          <p className="text-xl text-gray-600 mt-4">Secure Your IP Rights</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-all duration-300 animate__animated animate__fadeInUp">
            ...
            <div className="pt-16 p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">Senior Patent Attorney</p>
              <p className="text-gray-600 text-sm mb-6">15+ years experience in patent law and intellectual property rights</p>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-all duration-300 animate__animated animate__fadeInUp" style={{animationDelay: '0.2s'}}>
            ...
            <div className="pt-16 p-6 text-center">
              <h3 className="text-xl font-semibold text-blue-900">Michael Chen</h3>
              <p className="text-gray-600 mb-4">IP Strategy Consultant</p>
              <p className="text-gray-600 text-sm mb-6">Expert in international IP protection and strategy development</p>
              <div className="flex justify-center space-x-4">
                <a href="#" className="text-blue-900 hover:text-blue-700">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-all duration-300 animate__animated animate__fadeInUp" style={{animationDelay: '0.4s'}}>
            ...
            <div className="pt-16 p-6 text-center">
              <h3 className="text-xl font-semibold text-blue-900">Dr. Robert Miller</h3>
              <p className="text-gray-600 mb-4">Technical Expert</p>
              <p className="text-gray-600 text-sm mb-6">Specialized in technology patents and innovation protection</p>
              <div className="flex justify-center space-x-4">
                <a href="#" className="text-blue-900 hover:text-blue-700">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
        ...
        <div className="text-center mt-12 animate__animated animate__fadeIn">
          <a href="#ContactForm" className="inline-block bg-blue-900 text-white px-8 py-4 rounded-full font-semibold hover:bg-blue-800 transition-colors duration-300">
