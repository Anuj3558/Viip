...
const CopyrightInfringementPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSend = {
      ...formData,
      route: "/copyright-infringement",
      type: "copyright_infringement_inquiry",
    };
  ...
  return (
    <>
      <Helmet>
        <title>
          Copyright Infringement | Vastav Intellect and IP Solutions
        </title>
        <meta
          name="description"
          content="Protect your creative works from copyright infringement. Vastav Intellect and IP Solutions helps creators enforce their intellectual property rights."
        />
        <meta
          name="keywords"
          content="copyright infringement, protect creative works, intellectual property, Vastav Intellect, IP Solutions"
        />
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Protect your creative works from copyright infringement. Vastav
                Intellect and IP Solutions helps creators enforce their
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Take legal action against copyright infringement and
                      protect your rights.
                    </p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Tell us about the copyright infringement (e.g., work infringed, infringing party, etc.)"
                    required
                  ></textarea>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  We analyze potential copyright infringement cases and provide
                  actionable advice.
                </p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  We assist in enforcing your copyright and taking legal action
                  against infringers.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
        ...
        <section className="bg-gray-100 py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-8">
              Why Choose Vastav for Copyright Infringement?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center">
                ...
                <p className="text-gray-600">
                  We specialize in copyright infringement cases and enforcement.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center">
                ...
                <p className="text-gray-600">
                  We provide tailored solutions for your copyright infringement
                  needs.
                </p>
              </div>
            </div>
...
export default CopyrightInfringementPage;
