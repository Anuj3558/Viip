...
const TrademarkObjectionResponsePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSend = {
      ...formData,
      route: "/trademark-objection-response",
      type: "trademark_objection_response_inquiry",
    };
    ...
    try {
      const response = await fetch(
        ...
        }/trademark-ip/trademark-objection-response`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      <Helmet>
        <title>
          Trademark Objection Response | Vastav Intellect and IP Solutions
        </title>
        <meta
          name="description"
          content="Respond to trademark objections with expert assistance. Vastav Intellect and IP Solutions provides comprehensive services for overcoming trademark objections."
        />
        <meta
          name="keywords"
          content="trademark objection response, trademark objection, intellectual property, Vastav Intellect, IP Solutions, India"
        />
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Respond to trademark objections with expert assistance. Vastav
                Intellect and IP Solutions provides comprehensive services for
