...
import { FaCheckCircle, FaShieldAlt, FaSearch, FaFileSignature } from 'react-icons/fa'; // Import React Icons
...
const TrademarkRegistrationPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_APP_BACKEND_URL}/trademark-ip/trademark-registration`, {
                method: 'POST',
                headers: {
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        ...
                        <div className="md:w-1/2 space-y-6">
                            ...
                            <p className="text-lg text-gray-700">
                                Vastav Intellect and IP Solutions offers expert trademark registration services to protect your brand identity, prevent infringement, and build a strong brand presence in the market.
                            </p>
