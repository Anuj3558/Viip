...
import { FaCopyright, FaFileAlt, FaShieldAlt, FaUser } from "react-icons/fa"; // Import React Icons
...
const CopyrightRegistrationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSend = {
      ...formData,
      route: "/copyright-registration",
      type: "copyright_registration_inquiry",
    };
  ...
  return (
    <>
      <Helmet>
        <title>
          Copyright Registration | Vastav Intellect and IP Solutions
        </title>
        <meta
          name="description"
          content="Protect your creative works with copyright registration. Vastav Intellect and IP Solutions helps creators secure their intellectual property rights."
        />
        <meta
          name="keywords"
          content="copyright registration, protect creative works, intellectual property, Vastav Intellect, IP Solutions"
        />
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Protect your creative works with copyright registration. Vastav
                Intellect and IP Solutions helps creators secure their
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Safeguard your books, music, art, and other creative works
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Establish legal ownership of your creative works and
                      enforce your rights.
                    </p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Tell us about your creative work (e.g., book, music, art, etc.)"
                    required
                  ></textarea>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  We help you register your creative works with the appropriate
                  copyright office to establish legal ownership.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
                    Books, music, and art registration
                  </li>
                  <li className="flex items-center">
                    <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  against unauthorized use of your creative works.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  We help you license your creative works and ensure you receive
        ...
        <section className="bg-gray-100 py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-8">
              Why Choose Vastav for Copyright Registration?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center">
                ...
                <p className="text-gray-600">
                  We specialize in copyright protection for creative works.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center">
                ...
                <p className="text-gray-600">
                  We ensure your creative works are fully protected under
                  copyright law.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center">
                ...
                <p className="text-gray-600">
                  We provide tailored solutions for your copyright needs.
                </p>
              </div>
            </div>
          </div>
