...
const StartupIndiaRegistrationPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const dataToSend = {
            ...
            type: 'startup_india_registration_inquiry'
        };

        try {
            // Send data to backend API
            const response = await fetch(`${import.meta.env.VITE_APP_BACKEND_URL}/bussiness-setup/startup-india-registration`, {
                method: 'POST',
                headers: {
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="keywords" content="Startup India, registration, DPIIT, startup benefits, Vastav Intellect, IP Solutions, India" />
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        ...
                        <div className="md:w-1/2 space-y-6">
                            ...
                            <p className="text-lg text-gray-700">
                                Vastav Intellect and IP Solutions helps startups like yours navigate the registration process and access the benefits of the Startup India initiative. We provide expert guidance to ensure you maximize the opportunities available.
                            </p>
