          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Vastav Intellect and IP Solutions provides expert services for changing the
                Designated Partner(s) of your Limited Liability Partnership, ensuring a smooth
                transition and full compliance with legal requirements.
              </p>
