  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <h3 className="text-xl font-bold mb-2">Annual Return Filing</h3>
                <p className="text-gray-600 mb-4">Preparation and filing of LLP Form 11, ensuring compliance with regulatory requirements.</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <h3 className="text-xl font-bold mb-2">Statement of Accounts and Solvency</h3>
                <p className="text-gray-600 mb-4">Preparation and filing of LLP Form 8, including financial statements and solvency declaration.</p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <svg className="h-5 w-5 text-blue-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <h3 className="text-xl font-bold mb-2">Income Tax Return Filing</h3>
                <p className="text-gray-600 mb-4">Assistance with filing the LLP's Income Tax Return, ensuring compliance with tax laws.</p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <svg className="h-5 w-5 text-blue-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  ...
                  <li className="flex items-center">
                    ...
                    Filing of ITR with the Income Tax Department
                  </li>
                  <li className="flex items-center">
                    <svg className="h-5 w-5 text-blue-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
        ...
        {/* Process Section */}
        <section className="container mx-auto px-4 py-16">
          <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">Our Compliance Process</h2>
        ...
        <section className="bg-gray-100 py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-8">Why Choose Vastav for LLP Compliance?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center">
                ...
                <p className="text-gray-600">Our team possesses in-depth knowledge of LLP compliance regulations and requirements.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto h-12 w-12 text-blue-800 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-gray-600">We manage the entire compliance process, minimizing your effort and stress.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto h-12 w-12 text-blue-800 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-gray-600">We ensure your LLP meets all compliance requirements, avoiding penalties and legal issues.</p>
              </div>
            </div>
          </div>
        </section>
...
export default LLPAnnualCompliancePage;
