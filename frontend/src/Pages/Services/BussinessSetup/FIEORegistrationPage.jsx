...
const FIEORegistrationPage = () => {
  ...
  const showSuccessNotification = () => {
    setNotification({
      type: 'success',
      message: 'Success',
      description: 'FIEO Registration inquiry submitted successfully!'
    });
  };
  ...
  return (
    <>
      <Helmet>
        <title>FIEO Registration | Vastav Intellect and IP Solutions</title>
        <meta name="description" content="Get your FIEO Registration with Vastav Intellect and IP Solutions. Expert assistance for exporters in the Indian trade industry." />
      </Helmet>
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              <h2 className="text-3xl font-bold text-blue-800">FIEO Registration Services</h2>
              <p className="text-lg text-gray-700">
                Vastav Intellect and IP Solutions provides expert services for obtaining FIEO Registration, enabling exporters to access international markets and leverage trade benefits.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We simplify the FIEO registration process with minimal documentation.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-2 rounded-full mr-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We ensure your FIEO application complies with all trade regulations.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-2 rounded-full mr-3">
            ...
            <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-blue-800 mb-6">Inquire About FIEO Registration</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Tell us about your FIEO Registration requirements"
                    required
                  ></textarea>
                </div>
                <button
...
export default FIEORegistrationPage;