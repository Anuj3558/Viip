...
const APEDARCMCPage = () => {
  ...
  const showSuccessNotification = () => {
    setNotification({
      type: 'success',
      message: 'Success',
      description: 'APEDA RCMC inquiry submitted successfully!'
    });
  };
  ...
  return (
    <>
      <Helmet>
        <title>APEDA RCMC | Vastav Intellect and IP Solutions</title>
        <meta name="description" content="Get your APEDA RCMC with Vastav Intellect and IP Solutions. Expert assistance for exporters in the agricultural and processed food sectors." />
      </Helmet>
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              <h2 className="text-3xl font-bold text-blue-800">APEDA RCMC Services</h2>
              <p className="text-lg text-gray-700">
                Vastav Intellect and IP Solutions provides expert services for obtaining an APEDA RCMC, enabling exporters in the agricultural and processed food sectors to access international markets.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We simplify the RCMC registration process with minimal documentation.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-2 rounded-full mr-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We ensure your RCMC application complies with all APEDA regulations.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-2 rounded-full mr-3">
            ...
            <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-blue-800 mb-6">Inquire About APEDA RCMC</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Tell us about your APEDA RCMC requirements"
                    required
                  ></textarea>
                </div>
                <button
