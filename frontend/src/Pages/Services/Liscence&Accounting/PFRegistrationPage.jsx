...
const PFRegistrationPage = () => {
  ...
  const showSuccessNotification = () => {
    setNotification({
      type: "success",
      message: "Success",
      description: "PF Registration inquiry submitted successfully!",
    });
  };
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          Online PF Registration | Vastav Intellect and IP Solutions
        </title>
        <meta
          name="description"
          content="Get your PF Registration Online with Vastav Intellect and IP Solutions. Ensure compliance with Employees' Provident Fund regulations."
        />
        <meta
          name="keywords"
          content="PF registration, provident fund, employee PF, online registration, Vastav Intellect, legal services, India"
        />
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              <h2 className="text-3xl font-bold text-blue-800">
                Online PF Registration Services
              </h2>
              <p className="text-lg text-gray-700">
                Vastav Intellect and IP Solutions offers expert assistance in
                Employees' Provident Fund (PF) registration, ensuring your
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ensure compliance with PF regulations, providing essential
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We simplify the PF registration process, making it easy
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      complexities of PF regulations.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Providing information on the EPF scheme and its benefits for
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <h3 className="text-xl font-bold mb-2">
                  Online Filing and ECR Assistance
                </h3>
                <p className="text-gray-600 mb-4">
                  Assisting with online filing of PF returns and generating
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                We file your PF registration application online with the EPFO
                portal.
              </p>
            </div>
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                You receive your PF registration and guidance on ongoing
                compliance.
              </p>
            </div>
          </div>
