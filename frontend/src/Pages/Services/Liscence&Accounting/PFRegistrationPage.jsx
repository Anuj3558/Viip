            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <section className="container mx-auto px-4 py-16">
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        ...
                        <div className="md:w-1/2 space-y-6">
                            <h2 className="text-3xl font-bold text-blue-800">Online PF Registration Services</h2>
                            <p className="text-lg text-gray-700">
                                Vastav Intellect and IP Solutions offers expert assistance in Employees' Provident Fund (PF) registration,
                                ensuring your business complies with all relevant regulations and requirements.
                            </p>
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-lg">Employee Benefits Compliance</h3>
                                        <p className="text-gray-600">Ensure compliance with PF regulations, providing essential benefits to your employees.</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="bg-blue-100 p-2 rounded-full mr-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">We simplify the PF registration process, making it easy and efficient for your business.</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="bg-blue-100 p-2 rounded-full mr-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Get professional advice and support to navigate the complexities of PF regulations.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
                            <h2 className="text-2xl font-bold text-blue-800 mb-6">Register for PF with Us</h2>
                ...
                <section className="bg-gray-100 py-16">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">Our PF Registration Services</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                                ...
                                <p className="text-gray-600 mb-4">Helping you gather and prepare all the necessary documents for PF registration.</p>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                                ...
                                <h3 className="text-xl font-bold mb-2">EPF Scheme Guidance</h3>
                                <p className="text-gray-600 mb-4">Providing information on the EPF scheme and its benefits for employers and employees.</p>
                                <ul className="space-y-2 text-gray-600">
                                    <li className="flex items-center">
                                        <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
                                        Contribution rates
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                                ...
                                <h3 className="text-xl font-bold mb-2">Online Filing and ECR Assistance</h3>
                                <p className="text-gray-600 mb-4">Assisting with online filing of PF returns and generating Electronic Challan cum Return (ECR).</p>
                                <ul className="space-y-2 text-gray-600">
                                    <li className="flex items-center">
                                        <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
                                        Data preparation
                ...
                {/* Process Section */}
                <section className="container mx-auto px-4 py-16">
                    <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">Our PF Registration Process</h2>
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
                            ...
                            <p className="text-gray-600">We file your PF registration application online with the EPFO portal.</p>
                        </div>
                        <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
                            ...
                            <p className="text-gray-600">You receive your PF registration and guidance on ongoing compliance.</p>
                        </div>
                    </div>
                </section>
