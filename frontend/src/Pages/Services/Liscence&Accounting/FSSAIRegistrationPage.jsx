    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Get your FSSAI Registration with Vastav Intellect and IP Solutions. Expert assistance for Food Safety and Standards Authority of India compliance." />
                <meta name="keywords" content="FSSAI registration, food license, food safety, food business, food license consultant, Vastav Intellect, legal services, India" />
            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <section className="container mx-auto px-4 py-16">
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        ...
                        <div className="md:w-1/2 space-y-6">
                            <h2 className="text-3xl font-bold text-blue-800">FSSAI Registration Services</h2>
                            <p className="text-lg text-gray-700">
                                Vastav Intellect and IP Solutions offers expert assistance in obtaining FSSAI registration, ensuring your food business
                                complies with the Food Safety and Standards Authority of India regulations.
                            </p>
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Ensure your food business meets all FSSAI requirements for safe and legal operations.</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="bg-blue-100 p-2 rounded-full mr-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">We guide you through the entire FSSAI registration process, making it easy and efficient.</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="bg-blue-100 p-2 rounded-full mr-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Get professional advice and support to navigate the complexities of FSSAI regulations.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
                            <h2 className="text-2xl font-bold text-blue-800 mb-6">Apply for Your FSSAI Registration</h2>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    <label htmlFor="foodBusiness" className="block text-gray-700 font-medium mb-1">Type of Food Business</label>
                                    <input
                                        type="text"
                                        id="foodBusiness"
                                        name="foodBusiness"
                ...
                <section className="bg-gray-100 py-16">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">Our FSSAI Registration Services</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                                ...
                                <p className="text-gray-600 mb-4">Assistance with preparing and compiling all required documents for FSSAI registration.</p>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                                ...
                                <p className="text-gray-600 mb-4">Filing your FSSAI registration application with the relevant authorities.</p>
                                <ul className="space-y-2 text-gray-600">
                                    <li className="flex items-center">
                                        <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                                ...
                                <p className="text-gray-600 mb-4">Providing ongoing support to ensure your food business remains compliant with FSSAI regulations.</p>
                                <ul className="space-y-2 text-gray-600">
                                    <li className="flex items-center">
                                        <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
                                        Regulatory updates
                ...
                {/* Process Section */}
                <section className="container mx-auto px-4 py-16">
                    <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">Our FSSAI Registration Process</h2>
                    <div className="flex flex-col md:flex-row">
                        <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
                            ...
                            <p className="text-gray-600">We collect all necessary information about your food business.</p>
                        </div>
                        <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
                        ...
                        <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
                            ...
                            <h3 className="text-xl font-bold mb-2">Application Filing</h3>
                            <p className="text-gray-600">We file your FSSAI registration application online.</p>
                        </div>
                        <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
                            ...
                            <p className="text-gray-600">You receive your FSSAI registration certificate.</p>
                        </div>
                    </div>
                </section>
