  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Get your Professional Tax Registration with Vastav Intellect and IP Solutions. Ensure compliance with state-level professional tax regulations."
        />
        <meta
          name="keywords"
          content="professional tax, PT registration, tax registration, employee tax, Vastav Intellect, legal services, India"
        />
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                ...
                Professional Tax (PT) registration, ensuring your business
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ensure your business adheres to all applicable
                      professional tax laws and regulations.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We simplify the PT registration process, making it easy
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      complexities of PT regulations.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-blue-800 mb-6">
                Register for Professional Tax with Us
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Preparing all the necessary documents for professional tax
                  registration.
                </p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Assisting with enrolling your employees for professional tax
                  deductions.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Providing guidance on how to calculate and remit professional
                  tax payments.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                We collect all necessary information about your business and
                employees.
              </p>
            </div>
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
            ...
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                We file your professional tax registration application.
              </p>
            </div>
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              <div className="bg-blue-800 text-white rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mb-4">
              ...
              <p className="text-gray-600">
                You receive your professional tax registration certificate.
              </p>
            </div>
          </div>
        </section>
