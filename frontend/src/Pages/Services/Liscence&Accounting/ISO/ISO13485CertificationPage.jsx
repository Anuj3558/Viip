            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="md:w-1/2 space-y-6">
                ...
                <p className="text-lg text-gray-700">
                  Vastav Intellect and IP Solutions offers specialized
                  consulting services to help medical device manufacturers
                  achieve ISO 13485 certification and implement a robust Quality
