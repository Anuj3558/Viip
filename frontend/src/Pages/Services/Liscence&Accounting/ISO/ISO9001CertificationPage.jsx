  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Achieve ISO 9001:2015 Certification with Vastav Intellect and IP Solutions. Expert quality management system consulting."
        />
        <meta
          name="keywords"
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                ...
                help your organization achieve ISO 9001:2015 certification and
                implement an effective Quality Management System (QMS) that
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Consistently meet customer requirements and exceed
                      expectations.
                    </p>
                  </div>
                </div>
            ...
            <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-blue-800 mb-6">
                Get a Quote for ISO 9001:2015 Certification
              </h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Tell us about your company and ISO 9001:2015 certification goals"
                    required
                  ></textarea>
                </div>
                <button
                ...
                >
                  Request ISO 9001:2015 Certification Quote
                </button>
              </form>
            </div>
          </div>
        ...
        <section className="bg-gray-100 py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">
              Our ISO 9001:2015 Certification Services
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Comprehensive assessment of your current QMS against ISO
                  9001:2015 requirements to identify gaps.
                </p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  documentation and processes for ISO 9001:2015 compliance.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Assistance in conducting internal audits and management
                  reviews to ensure the effectiveness of your QMS.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
        ...
        <section className="container mx-auto px-4 py-16">
          <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">
            Our ISO 9001:2015 Certification Process
          </h2>
