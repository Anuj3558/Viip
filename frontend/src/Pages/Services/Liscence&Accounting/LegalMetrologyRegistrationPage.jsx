...
const LegalMetrologyRegistrationPage = () => {
  ...
  const showSuccessNotification = () => {
    setNotification({
      ...
      message: "Success",
      description:
        "Legal Metrology Registration inquiry submitted successfully!",
    });
  };
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          Legal Metrology Registration | Vastav Intellect and IP Solutions
        </title>
        <meta
          name="description"
          content="Get your Legal Metrology Registration with Vastav Intellect and IP Solutions. Ensure compliance with weights and measures regulations."
        />
        <meta
          name="keywords"
          content="legal metrology, weights and measures, registration, compliance, Vastav Intellect, legal services, India"
        />
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                ...
                obtaining Legal Metrology registration, ensuring your business
                complies with the regulations governing weights and measures in
                India.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ensure your business complies with all Legal Metrology
                      regulations.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We simplify the Legal Metrology registration process,
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Get professional advice and support to navigate Legal
            ...
            <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-blue-800 mb-6">
                Register for Legal Metrology with Us
              </h2>
        ...
        <section className="bg-gray-100 py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">
              Our Legal Metrology Registration Services
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Helping you gather and prepare all necessary documents for
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Providing guidance on compliance with Legal Metrology
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <p className="text-gray-600 mb-4">
                  Filing your Legal Metrology registration application and
        ...
        <section className="container mx-auto px-4 py-16">
          <h2 className="text-3xl font-bold text-center text-blue-800 mb-12">
            Our Legal Metrology Registration Process
          </h2>
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                We assist you in preparing all the required documents for
                registration.
              </p>
            </div>
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                We file your Legal Metrology registration application online.
              </p>
            </div>
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              <div className="bg-blue-800 text-white rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mb-4">
              ...
              <p className="text-gray-600">
                You receive your Legal Metrology registration certificate.
              </p>
            </div>
          </div>
        </section>
