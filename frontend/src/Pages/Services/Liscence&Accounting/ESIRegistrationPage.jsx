...
const ESIRegistrationPage = () => {
  ...
  const showSuccessNotification = () => {
    setNotification({
      type: "success",
      message: "Success",
      description: "ESI Registration inquiry submitted successfully!",
    });
  };
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          Online ESI Registration | Vastav Intellect and IP Solutions
        </title>
        <meta
          name="description"
          content="Get your ESI Registration Online with Vastav Intellect and IP Solutions. Ensure compliance with Employees' State Insurance regulations."
        />
        <meta
          name="keywords"
          content="ESI registration, employee state insurance, online registration, employee benefits, Vastav Intellect, legal services, India"
        />
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              <h2 className="text-3xl font-bold text-blue-800">
                Online ESI Registration Services
              </h2>
              <p className="text-lg text-gray-700">
                Vastav Intellect and IP Solutions offers expert assistance in
                Employees' State Insurance (ESI) registration, ensuring your
                business complies with all relevant regulations and
                requirements, providing social security benefits to your
                employees.
              </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ensure compliance with ESI regulations, providing
                      essential social security benefits to your employees.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We simplify the ESI registration process, making it easy
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      complexities of ESI regulations.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <h3 className="text-xl font-bold mb-2">
                  ESI Scheme Information
                </h3>
                <p className="text-gray-600 mb-4">
                  Providing information on the ESI scheme and its benefits for
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                ...
                <h3 className="text-xl font-bold mb-2">
                  Online Filing and Compliance Assistance
                </h3>
                <p className="text-gray-600 mb-4">
                  Assisting with online filing of ESI returns and ensuring
                  ongoing compliance with ESI regulations.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <FaCheckCircle className="h-5 w-5 text-blue-600 mr-2" />
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                We collect all the necessary information about your company and
                employees.
              </p>
            </div>
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
            ...
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                We file your ESI registration application online with the ESIC
                portal.
              </p>
            </div>
            <div className="md:w-1/4 p-4 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                You receive your ESI registration and guidance on ongoing
                compliance.
              </p>
            </div>
          </div>
