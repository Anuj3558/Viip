...
const FounderAgreementPage = () => {
  ...
  const showSuccessNotification = () => {
    setNotification({
      type: 'success',
      message: 'Success',
      description: 'Founder Agreement inquiry submitted successfully!'
    });
  };
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              <h2 className="text-3xl font-bold text-blue-800">Founder Agreement Services</h2>
              <p className="text-lg text-gray-700">
                Vastav Intellect and IP Solutions provides expert services for drafting Founder Agreements, helping founders establish clear roles and responsibilities effectively.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We assist with drafting professional Founder Agreements that are legally compliant and effective.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-2 rounded-full mr-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">Roles and Responsibilities</h3>
                    <p className="text-gray-600">We help define roles and responsibilities among founders in Founder Agreements.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-2 rounded-full mr-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We provide expert guidance on drafting effective Founder Agreements.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-blue-800 mb-6">Inquire About Founder Agreement</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Tell us about your Founder Agreement requirements"
                    required
                  ></textarea>
                </div>
                <button
...
export default FounderAgreementPage;
