...
const GstInvoicePage = () => {
  ...
  const showSuccessNotification = () => {
    setNotification({
      type: 'success',
      message: 'Success',
      description: 'GST Invoice inquiry submitted successfully!'
    });
  };
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              <h2 className="text-3xl font-bold text-blue-800">GST Invoice Services</h2>
              <p className="text-lg text-gray-700">
                Vastav Intellect and IP Solutions provides expert services for drafting GST invoices, helping businesses comply with GST regulations and maintain accurate financial records.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We assist with drafting professional GST invoices that are compliant with GST laws and regulations.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-2 rounded-full mr-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We ensure all GST invoices comply with GST laws and financial regulations.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-2 rounded-full mr-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We provide expert guidance on drafting effective GST invoices.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-blue-800 mb-6">Inquire About GST Invoice</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Tell us about your GST invoice requirements"
                    required
                  ></textarea>
                </div>
                <button
