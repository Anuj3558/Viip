...
const BusinessLoanPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Business Loan | Vastav Intellect and IP Solutions</title>
        <meta
          name="description"
          content="Apply for a Business Loan to grow your business. Vastav Intellect and IP Solutions offers expert assistance for securing business loans."
        />
        <meta
          name="keywords"
          content="business loan, business funding, loan application, Vastav Intellect"
        />
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Apply for a Business Loan to grow your business. Vastav
                Intellect and IP Solutions offers expert assistance for securing
                business loans.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Secure funding to expand your business operations and
                      reach new heights.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We offer flexible repayment terms tailored to your
                      business needs.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Get quick approval and access to funds to meet your
