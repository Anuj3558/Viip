...
import { FaTransgender, FaFileAlt, FaHandshake } from "react-icons/fa"; // Import React Icons
...
const GenderChangePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Gender Change | Vastav Intellect and IP Solutions</title>
        <meta
          name="description"
          content="Legally change your gender with expert guidance. Vastav Intellect and IP Solutions provides seamless assistance for gender change processes."
        />
        <meta
          name="keywords"
          content="gender change, legal gender change, gender change process, Vastav Intellect"
        />
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Tell us about your gender change needs (e.g., reason for change, legal concerns, etc.)"
                    required
                  ></textarea>
                </div>
                <button
...
export default GenderChangePage;